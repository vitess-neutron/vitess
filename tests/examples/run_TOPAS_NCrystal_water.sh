...
$V/window${SUFFIX} --Z1 --U1.0e-25 --G1 --T0 --B10000 --P$P --N19 --L${L}19 -l90 -R1 -r10 -y0 -z0 -w-1 -W1 -h-2.5 -H2.5 -A0.0 -S0 -F0 -c6 -t0.0 -T0 | \
...
$V/sample_ncrystal${SUFFIX} --Z1 --U1.0e-25 --G1 --T0 --B10000 --P$P --N23 --L${L}23 -f$P/LiquidWaterH2O_T293.6K.ncmat -T293.6 -s0 -d0.5 -m0.2 -D0.0057 -h1 -k1 -l1 -a1 -b1 -c1 -H1 -K1 -L0 -A1 -B1 -C0 -R1 -G2 -X50 -Y0 -Z0 -t3 -g3 -w2.8 -o0 -O0 -M1.8 -x50 -y0 -z0 -u0 -U0 | \
