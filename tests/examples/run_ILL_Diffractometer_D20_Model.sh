...
$V/source${SUFFIX} -S1 --Z1 --U1.0e-25 --G1 --T0 --B10000 --P$P --N1 --L${L}01 -a$P/ILL_thml_2011.mod -n4e4 -l1 -m2.33 -M2.49 -d1 -b0.0 -c0.0 -y0.5 -z0.5 -D251.2 -w15 -h15 -i0 -s200 -X1 -Y0 -V0 -P0 -A0 -k0 | \
$V/frame${SUFFIX} --Z1 --U1.0e-25 --G1 --T0 --B10000 --P$P --N2 --L${L}02 -S1 -H0 -V0 -A45 -x0 -y0 -z0 -i0 -j0 -k0 | \
$V/spacewindow${SUFFIX} --Z1 --U1.0e-25 --G1 --T0 --B10000 --P$P --N3 --L${L}03 -l0 -R0 -r10 -y0 -z0 -w-8.85 -W8.85 -h-8.85 -H8.85 -S0 -F0 -c6 -t0.0 -T0 | \
...
$V/spacewindow${SUFFIX} --Z1 --U1.0e-25 --G1 --T0 --B10000 --P$P --N6 --L${L}06 -l102 -R1 -r5.65 -y0 -z0 -S0 -F0 -c6 -t0.0 -T0 | \
$V/spacewindow${SUFFIX} --Z1 --U1.0e-25 --G1 --T0 --B10000 --P$P --N7 --L${L}07 -l51 -R1 -r5.55 -y0 -z0 -S0 -F0 -c6 -t0.0 -T0 | \
$V/spacewindow${SUFFIX} --Z1 --U1.0e-25 --G1 --T0 --B10000 --P$P --N8 --L${L}08 -l95.7 -R1 -r5.75 -y0 -z0 -S0 -F0 -c6 -t0.0 -T0 | \
$V/spacewindow${SUFFIX} --Z1 --U1.0e-25 --G1 --T0 --B10000 --P$P --N9 --L${L}09 -l1140.1 -R0 -r10 -y0 -z0 -w-4.75 -W4.75 -h-15 -H15 -S0 -F0 -c6 -t0.0 -T0 | \
...
$V/spacewindow${SUFFIX} --Z1 --U1.0e-25 --G1 --T0 --B10000 --P$P --N16 --L${L}16 -l40 -R0 -r1 -y0 -z0 -w-7.5 -W7.5 -h-15 -H15 -S0 -F0 -c6 -t0.0 -T0 | \
...
$V/spacewindow${SUFFIX} --Z1 --U1.0e-25 --G1 --T0 --B10000 --P$P --N18 --L${L}18 -l240 -R0 -r1 -y0 -z0 -w-1.5 -W1.5 -h-6 -H6 -S0 -F0 -c6 -t0.0 -T0 | \
