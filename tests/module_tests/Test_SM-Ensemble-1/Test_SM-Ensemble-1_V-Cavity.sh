...
$V/sm_ensemble_parallel${SUFFIX} --Z1 --U1.0e-26 --G0 --T0 --B10000 --P$P --N2 --L${L}02 -P$P/V-Polarizer.dat -F1 -S1 -R0 -Q2 -r200 -s0 -t0 -h0 -v0 -T0 -o1 -c0 -M1000 -C$P/collision.dat -m500 | \
