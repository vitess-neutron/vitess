...
[ -z "$P" ] && P=/tmp/vitess/tests/module_tests/Test_SampleRefl-1
[ -z "$L" ] && L=/tmp/vitess8305c9fvpipelog
...
$V/sample_reflectom${SUFFIX} --Z1 --U1.0e-25 --G1 --T0 --B10000 --P$P --N2 --L${L}02 -P$P/geom-1.ref -I$P/refl_Si-50Au.dat -O1 -RY -A1 -a1.2 -M0 -h0.2 -s4 -o0 -B0 -X0 -S1 -d0 -p0 -t0 | \
