...
$V/guide${SUFFIX} --Z1 --U1.0e-25 --G1 --T0 --B10000 --P$P --N2 --L${L}02 -Y0 -Z0 -S$P/guide_shape_out.dat -w3 -h3 -W3 -H3 -p50 -N10 -L3 -Q3 -G3 -M0 -m0 -a0 -g-1 -A0 -l0 -r0.5 -n0 -v0 -e0 -E0 -c0 -C0 -d0 -D0 -B0 -T10 -V17 -k1000 -x0 -X10000 -K100 -u0 -U10 | \
