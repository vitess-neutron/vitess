...
$V/mon_brilliance${SUFFIX} --Z1 --U1.0e-25 --G1 --T0 --B10000 --P$P --N10 --L${L}10 -O$P/monitor-9_out.dat -n100 -C-1 -k1 -N1 -B0 -l1 -L10 -y-2 -Y2 -z-2 -Z2 -h-1 -H1 -v-1 -V1 | \
...
$V/monitorpol_1d${SUFFIX} -k2 --Z1 --U1.0e-25 --G1 --T0 --B10000 --P$P --N19 --L${L}19 -O$P/monitor-18_out.dat -n100 -C-1 -m1 -M10 -p1 -e0 -a1 -b1 -c1 | \
$V/monitorpol_1d${SUFFIX} -k1 --Z1 --U1.0e-25 --G1 --T0 --B10000 --P$P --N20 --L${L}20 -O$P/monitor-19_out.dat -n100 -C-1 -m1 -M10 -p1 -e0 -a1 -b1 -c1 | \
$V/monitorpol_1d${SUFFIX} -k5 --Z1 --U1.0e-25 --G1 --T0 --B10000 --P$P --N21 --L${L}21 -O$P/monitor-20_out.dat -n100 -C-1 -m-3 -M3 -p1 -e0 -a1 -b1 -c1 | \
$V/monitorpol_1d${SUFFIX} -k6 --Z1 --U1.0e-25 --G1 --T0 --B10000 --P$P --N22 --L${L}22 -O$P/monitor-21_out.dat -n100 -C-1 -m-3 -M3 -p1 -e0 -a1 -b1 -c1 | \
$V/monitorpol_1d${SUFFIX} -k3 --Z1 --U1.0e-25 --G1 --T0 --B10000 --P$P --N23 --L${L}23 -O$P/monitor-22_out.dat -n100 -C-1 -m-1 -M1 -p1 -e0 -a1 -b1 -c1 | \
$V/monitorpol_1d${SUFFIX} -k4 --Z1 --U1.0e-25 --G1 --T0 --B10000 --P$P --N24 --L${L}24 -O$P/monitor-23_out.dat -n100 -C-1 -m-1 -M1 -p1 -e0 -a1 -b1 -c1 | \
