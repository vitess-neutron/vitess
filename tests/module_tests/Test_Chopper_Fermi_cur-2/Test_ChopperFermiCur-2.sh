...
$V/chopper_fermi_parallel${SUFFIX} -O2 --Z1 --U1.0e-25 --G1 --T0 --B10000 --P$P --N2 --L${L}02 -X10 -Y0 -V0 -a5 -b5 -c3 -l20 -m0.02 -r7.1 -n300 -q-74.529 -L1.3 -z1 -g2 -G$P/ch_fermi_geom_out.dat -p4 | \
