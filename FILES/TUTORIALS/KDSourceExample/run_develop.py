...
VPATH = '/home/nschmidt/vitess/develop/MODULES'
LPATH = '/tmp/nschmidt63ea38f8vpipelog'
PPATH = '.'
...
source = '{:s}/read_in_Linux_x86_64 {:s} --N1 --L{:s}01 '.format(VPATH, SETTS, LPATH)
...
space = '{:s}/space_Linux_x86_64 {:s} --N2 --L{:s}02 '.format(VPATH, SETTS, LPATH)
space += '-d10 -M0 -m0'
space += '|'

monitor = '{:s}/writeout_Linux_x86_64 {:s} --N3 --L{:s}03 '.format(VPATH, SETTS, LPATH)
monitor += '-A{:s}/tracks_kds.mcpl -a1 -h1 -f3 -F0 -S0 -I1.0 -c111111111 -C-1'.format(PPATH)
monitor += ' | '

detector = '{:s}/detector_Linux_x86_64 {:s} --N4 --L{:s}04 '.format(VPATH, SETTS, LPATH)
