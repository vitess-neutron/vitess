...
[Setup]
AppName=Vitess
AppVerName=Vitess version 3.6
AppCopyright=GNU GPL (C) 2024 Forschungszentrum Jülich GmbH
...
[Files]
Source: "C:\vitess3.6\*"; DestDir: "{app}"; Flags: recursesubdirs; Components: main
...
Source: "C:\vitess3.6\install-windows.txt"; DestDir: "{app}"; Flags: isreadme

[Icons]
Name: "{userdesktop}\Vitess3.6"; Filename: "{app}\bin\wish86t.exe"; IconFilename: "{app}\Bitmaps\vwish.exe"; Parameters: " -f Vitess"; WorkingDir: "{app}"; Tasks: desktopicon
