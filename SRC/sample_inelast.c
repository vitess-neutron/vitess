...
#define	STRING_BUFFER 50
	...
	VectorType	Pos, Dir, Pos1, Pos2, Pos3, Pos4, random_main, random_range, k_reference, PosSample, DimSample, DimSampleHol, TranslOut;
	Neutron		Neutrons ;
...
CHECK;
	...
	if(Option[1] == 'y')
	{
		if(IntersectionWithCylinder(DimSample, Pos, Dir, Pos1, Pos2) == 0) goto getlost2 ; 
	}
	...
	if(Option[1] == 'u')
	{
		if(IntersectionWithRectangular(DimSample, Pos, Dir, Pos1, Pos2) == 0) goto getlost2 ; 
	}

	if(Option[1] == 'a')
	{
		if(IntersectionWithSphere(DimSample, Pos, Dir, Pos1, Pos2) == 0) goto getlost2 ; 
	}
