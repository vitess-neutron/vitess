...
void GeometryTestBender(Bender BenderMy,
    double *XENR, double *YENR, double *XENL, double *YENL,
    double *XEXR, double *YEXR, double *XEXL, double *YEXL,
...

{
  ...
  temp1 =
    XX*XX*BenderMy.SurfTopBottom[0].A +
  ...
  temp2 =
    XX*XX*BenderMy.SurfTopBottom[1].A +
