...
long IntersectionWithRectangular   (const VectorType DimSample, const VectorType Pos, const VectorType Dir,  VectorType Pos1, VectorType Pos2);
long IntersectionWithInfiniteCylinder(const double DiameterCyl, const VectorType Pos, const VectorType Dir,  VectorType Pos1, VectorType Pos2);
long IntersectionWithCylinder      (const VectorType DimSample, const VectorType Pos, const VectorType Dir,  VectorType Pos1, VectorType Pos2);
long IntersectionWithHorCyl(const double Len, const double Dia, const VectorType Pos, const VectorType Dir,  VectorType Pos1, VectorType Pos2);
long IntersectionWithSphere        (const VectorType DimSample, const VectorType Pos, const VectorType Dir,  VectorType Pos1, VectorType Pos2);

/* General functions  */
/* ------------------ */
int  PlaneLineIntersect (const VectorType LineOffset, const VectorType LineDir, const VectorType PlaneNormalVector, const double PlaneDistane, VectorType Result);
int  PlaneLineIntersect2(const VectorType LineOffset, const VectorType LineDir, const VectorType PlaneNormalVector, const double PlaneDistane, VectorType Result);
