...
- Download and unpack VITESS: run `curl -L https://iffgit.fz-juelich.de/vitess/vitess/-/jobs/1212128/artifacts/raw/Downloads/Vitess3.8-Darwin-universal.tar.gz | tar xz` in the terminal.
